...
if __name__ == "__main__":
    ...
    user_question = "Как работает генеративная нейросеть?"
    
    category, response = process_user_query(user_id, user_question, tfidf_vectorizer, faiss_index, knowledge_base)
